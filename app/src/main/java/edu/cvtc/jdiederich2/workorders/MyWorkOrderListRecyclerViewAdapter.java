...
import edu.cvtc.jdiederich2.workorders.WorkOrderListFragment.OnListFragmentInteractionListener;
...
public class MyWorkOrderListRecyclerViewAdapter extends RecyclerView.Adapter<MyWorkOrderListRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from( parent.getContext() )
                .inflate( R.layout.activity_workorderlist, parent, false );
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        // TODO: Verify this if this doesn't work. was originally .id
        holder.mIdView.setText( mValues.get( position ).getOrderID() );
        holder.mContentView.setText( mValues.get( position ).getCsAccountNum() );
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super( view );
            mView = view;
            mIdView = (TextView) view.findViewById( R.id.textView_LastName );
            mContentView = (TextView) view.findViewById( R.id.textView_City );
        }
